...
const Notifications: React.FC<NotificationsProps> = ({ notifications, onMarkAllRead }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
      <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500 w-full">
        <header className="flex flex-col gap-4">
          <div className="w-full">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white flex items-center justify-start md:justify-start">
              <Bell className="mr-3 text-indigo-600 dark:text-indigo-400" size={28} />
              All Notifications
            </h1>
            <p className="text-sm md:text-base text-gray-500 dark:text-gray-400 mt-2">Stay updated with your latest activities and system alerts</p>
          </div>
          <button 
            onClick={onMarkAllRead}
            className="w-full md:w-auto px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-bold flex items-center justify-center md:justify-start hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 dark:shadow-none active:scale-95"
          >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          <div className="p-4 md:p-6 border-b border-gray-50 dark:border-gray-700 flex flex-col gap-3 bg-gray-50/30 dark:bg-gray-900/20">
            ...
            <div className="flex items-center space-x-2 w-full">
              ...
              <select 
                ...
                className="w-full md:w-auto flex-1 md:flex-none md:min-w-40 px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-indigo-500"
              >
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-700">
            {paginatedNotifications.length > 0 ? (
              paginatedNotifications.map((n) => {
                ...
                return (
                  <div key={n.id} className={`p-4 md:p-6 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group ${!n.read ? 'bg-indigo-50/10 dark:bg-indigo-900/5' : ''}`}>
                    <div className="flex items-start space-x-3 md:space-x-4">
                      ...
                      <div className="flex-1 min-w-0 w-full">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed break-words">
                          {n.desc}
                        </p>
                      </div>
                    </div>
          ...
          {totalPages > 1 && (
            <div className="p-4 md:p-6 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <span className="text-xs font-bold text-gray-400 text-center md:text-left">
